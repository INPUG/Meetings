...
"@
  ...
  New-DotNetToast -Title 'Hellow @INPSUG!' -Message "How did you like this demo? Questions?"

#endregion

#region PoshNotify -- Cross platform Toast notifications. Windows/macOS/Linux supported

Install-Module PoshNotify

Send-OSNotification -Title "Demo" -Body "Main message body text"
